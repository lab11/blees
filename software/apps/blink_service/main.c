...
int main(void) {
    ...
    //add pir service
    simple_ble_add_service(&pir_service);

    //add chars
    simple_ble_add_characteristic(1,0,0,0,
                                    1, &pir_data.current_motion,
                                    &pir_service,
                                    &current_motion_char);
    simple_ble_add_characteristic(1,0,0,0,
                                    1, &pir_data.motion_since_last_adv,
                                    &pir_service,
                                    &motion_since_last_adv_char);
    simple_ble_add_characteristic(1,0,0,0,
                                    1, &pir_data.motion_last_minute,
                                    &pir_service,
                                    &motion_last_minute_char);
